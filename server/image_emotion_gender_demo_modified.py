...
def demo_emotion(image_str):
    # parameters for loading data and images
    # image_path = sys.argv[1]
    image_path = "images/" + image_str + ".jpg"
    ...
    gender_model_path = 'face_classification/trained_models/gender_models/simple_CNN.81-0.96.hdf5'
    ...
    cv2.imwrite('images/' + image_str + '_emotion.jpg', bgr_image)